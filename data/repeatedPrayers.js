        ...
        <div class="section" id="section_${sectionNumber}">
            <table id="table_${tableNumber1}" title="Paschal Praise">
                ...
                <tr id="table_${tableNumber1}_row_3" class="priest">
                    ...
                    <td class="arabic">تسبيحة الساعة ${aHour} من ${aDay} من البصخة المقدسة بركاتها علينا، أمين.
                    </td>
                </tr>
...
function copticGospelIntro(tableNumber) {
    ...
    <table id="table_${tableNumber}" title="We Beseech">
        ...
        <span class="arabic-caption">لكى نكون مستحقين</span></caption>
...
function daytimeExpositionIntro(tableNumber) {
    ...
    <table id="table_${tableNumber}" title="Daytime Exposition Introduction">
        ...
        <tr id="table_${tableNumber}_row_4" class="priest">
            ...
            <td class="coptic">Ⲡⲓⲟⲩⲱⲓⲛⲓ ̀ⲛⲧⲁ  ̀ ⲫⲙⲏⲓ :</td>
...
function evnotiNaiNan(tableNumber) {
    ...
    <table id="table_${tableNumber}" title="Evnoti Nai Nan">
        ...
        <tr id="table_${tableNumber}_row_4" class="text">
        ...
        <tr id="table_${tableNumber}_row_6" class="text">
        ...
        <tr id="table_${tableNumber}_row_8" class="text">
        ...
        <tr id="table_${tableNumber}_row_10" class="text">
    ...
    let html = `
        <table id="table_${tableNumber}" title="End of Service Hymn">
            ...
            <tr id="table_${tableNumber}_row_12" class="priest">
                <td class="english">O King of peace, grant us Your peace, establish for us Your peace, and forgive us our sins. For Yours is the power, the glory, the blessing, and the majestry, forever. Amen.</td>
