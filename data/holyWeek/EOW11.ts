import { hourIntro, paschalPraise2 , copticGospelIntro, nighttimeExpositionIntro, expositionConclusion, nighttimeLitanies, evnotiNaiNan, endOfServiceHymn , cross} from "../repeatedPrayers";

export const EOW11 = () => {
    const hourIntroHtml = hourIntro("ELEVENTH","الحادية عشر","EVE of WEDNESDAY","ليلة الاربعاء");
    const paschalPraiseHtml = paschalPraise2("4","4","5","ELEVENTH","الحادية عشر","EVE of WEDNESDAY","ليلة الاربعاء");
...
<table id="table_3" title="1st Prophecy">
    ...
    <tr id="table_3_row_1" class="intro">
        ...
        <td class="arabic">من حكمة سليمان النبى بركته تكون معنا، آمين.</td>
    </tr>
    <tr id="table_3_row_4" class="text">
        <td class="english">For wisdom is more mobile than any motion; because of her pureness she pervades and penetrates all things.</td>
        <td class="arabic">إن الحكمة تتحرك في كل متحرك فهي تبلغ وتأتي على الكل من أجل طهارتها،</td>
    </tr>
    <tr id="table_3_row_5" class="text">
        <td class="english">For she is a breath of the power of God, and a pure emanation of the glory of the Almighty; therefore nothing defiled gains entrance into her.</td>
        <td class="arabic">فإنها لهب قوة الله، وفيض من المجد المقدس الذي لضابط الكل، فلذلك لا يقدر أن يقربها شيء دنس</td>
    </tr>
    <tr id="table_3_row_6" class="text">
        <td class="english">For she is a reflection of eternal light, a spotless mirror of the working of God, and an image of his goodness.</td>
        <td class="arabic">لأنها ضياء النور الأزلي، ومرآة أعمال الله النقية وصورة صلاحه</td>
    </tr>
    <tr id="table_3_row_7" class="text">
        <td class="english">Though she is but one, she can do all things, and while remaining in herself, she renews all things; in every generation she passes into holy souls and makes them friends of God, and prophets;</td>
        <td class="arabic">تقدر على كل شيء وهي واحدة وتجدد كل شيء، وهي ثابتة في ذاتها وفي كل جيل تحل في النفوس الطاهرة وتجعلهم شركاء الله وتصيرهم أنبياء</td>
    </tr>
    <tr id="table_3_row_8" class="text">
        <td class="english">for God loves nothing so much as the man who lives with wisdom.</td>
        <td class="arabic">لأن الله لا يحب أحداً إلا من يساكن الحكمة</td>
    </tr>
    <tr id="table_3_row_9" class="text">
        <td class="english">For she is more beautiful than the sun, and excels every constellation of the stars. Compared with the light she is found to be superior,</td>
        <td class="arabic">لأنها أبهى من الشمس، وأسمَى من كل مركز النجوم، وإذا قيست بالنور تقدمت عليه،</td>
    </tr>
    <tr id="table_3_row_10" class="text">
        <td class="english">for it is succeeded by the night, but against wisdom evil does not prevail.</td>
        <td class="arabic">لأن النور يعقبه الليل، وأما الحكمة فلا تقوى عليها الظلام. مجداً للثالوث الأقدس.</td>
    </tr>
...
<div class="section" id="section_5" title="Coptic Psalm & Gospel">
    <table id="table_6" title="Coptic Psalm">
        ...
        <span class="arabic-caption">المزمور قبطياً<br>(56: 1)</span></caption>
...
<table id="table_9" title="Psalm">
    ...
    <span class="arabic-caption">المزمور<br>(56: 1)</span></caption>
