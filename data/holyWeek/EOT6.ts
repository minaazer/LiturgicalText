...
export const EOT6 = () => {
    ...
    const paschalPraiseHtml = paschalPraise1("4","4","5","SIXTH","السادسة","EVE of TUESDAY","ليلة الثلاثاء");
...
<div class="section" id="section_2" title="Coptic Prophecies">
    ...
    <span class="arabic-caption">النبوات قبطياً</span></caption>
        ...
        <tr id="table_2_row_4" class="text">
            <td class="coptic"> Ⲛ̀ⲑⲟⲕ ⲇⲉ ⲡ̀Ⲓ̀ⲥ̅ⲗ̅ ⲙ̀ⲡⲉⲣⲉⲣⲁⲧ ⲉ̀ⲙⲓ : ⲟⲩⲟϩ Ⲓⲟⲩⲇⲁ ⲙ̀ⲡⲉⲣϣⲉ ⲉ̀ϧⲟⲩⲛ ⲉ̀ⲅⲁⲗⲅⲁⲇⲁ : ⲟⲩⲟϩ ⲙ̀ⲡⲉⲣϣⲉⲛⲱⲧⲉⲛ ⲉ̀ϩ̀ⲣⲏⲓ ⲉⲡ̀ϭⲓⲛ̀ϫⲟⲛⲥ : ⲟⲩⲟϩ ⲙ̀ⲡⲉⲣⲱⲣⲕ ⲙ̀Ⲡ⳪ ⲉⲧⲟⲛϧ.</td>
        </tr>
...
<div class="section" id="section_5" title="Coptic Psalm & Gospel">
    <table id="table_6" title="Coptic Psalm">
        ...
        <span class="arabic-caption">المزمور قبطياً<br>(90: 1 ، 2)</span></caption>
        ...
        <tr id="table_6_row_1" class="text">
            ...
            <td class="coptic">Ⲡⲁⲙⲁ ⲙ̀ⲫⲱⲧ ⲡⲁⲛⲟⲩϯ ϯⲛⲁⲉⲣϩⲉⲗⲡⲓⲥ ⲉ̀ⲣⲟϥ :</td>
...
<table id="table_9" title="Psalm">
    ...
    <span class="arabic-caption">المزمور<br>(90: 1 ، 2)</span></caption>
    ...
    <tr id="table_9_row_4" class="text">
        <td class="english">You are my helper and my refuge; my God; I will trust in Him.</td>
        <td class="arabic">ملجأي والهي فأتكل عليه</td>
    </tr>
    <tr id="table_9_row_5" class="text">
        <td class="english">For He shall deliver you from the snare of the fowler, and from every troublesome matter.</td>
...
<table id="table_50" title="Next Hour">
    <tr id="table_50_row_0" data-navigation="EOT9sc" class="navigationButton">
        <td class="englishButton">The NINTH Hour of the EVE of TUESDAY</td>
        <td class="arabicButton">الساعة التاسعة من ليلة الثلاثاء</td>
    </tr>
