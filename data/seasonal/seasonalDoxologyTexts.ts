...
const seasonalDoxologyFunctionNames = [
    ...
    { name: "Nativity Season", functions: ["firstFeastofNativityDoxology","secondFeastofNativityDoxology","thirdFeastofNativityDoxology"], visible: false, toggle: false },
    ...
    { name: "2nd Day of Theophany", functions: ["firstFeastofTheophanyDoxology","secondFeastofTheophanyDoxology"], visible: false, toggle: false },
