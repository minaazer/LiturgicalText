#!/usr/bin/env python3
"""
Fetch the Holy Matrimony prayers from Tasbeha and convert them to the
...
CATEGORY_PATH = "/hymn_library/cat/235"
...
def main(output_path: Path = Path("data/jsons/holyMatrimony.json")) -> None:
