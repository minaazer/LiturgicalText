#!/usr/bin/env python3
"""
Fetch the Unction of the Sick prayers from Tasbeha and convert them to the
...
CATEGORY_PATH = "/hymn_library/cat/236"
...
def main(output_path: Path = Path("data/jsons/unctionOfTheSick.json")) -> None:
