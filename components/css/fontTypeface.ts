...
const fontFaces: FontFace[] = [
  ...
  { family: 'Noto Naskh Arabic', modules: [{ module: require('../../assets/fonts/NotoNaskhArabic-Regular.ttf'), format: 'truetype' }] },
  { family: 'Noto Naskh Arabic', weight: '500', modules: [{ module: require('../../assets/fonts/NotoNaskhArabic-Medium.ttf'), format: 'truetype' }] },
  { family: 'Noto Naskh Arabic', weight: '600', modules: [{ module: require('../../assets/fonts/NotoNaskhArabic-SemiBold.ttf'), format: 'truetype' }] },
  { family: 'Noto Naskh Arabic', weight: '700', modules: [{ module: require('../../assets/fonts/NotoNaskhArabic-Bold.ttf'), format: 'truetype' }] },
