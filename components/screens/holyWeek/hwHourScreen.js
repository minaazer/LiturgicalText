...
import { renderHour } from "../../../data/holyWeek/renderHour";
...
const HolyWeekHourScreen = ({ route }) => {
  ...
  const body = renderHour(serviceName, hourName, hourData.sections,  onePageSettings , paschalReadingsFull, variables);
